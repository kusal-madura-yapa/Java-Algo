...
public class CircularQueue<T> {
    ...
    public static void main(String[] args) {
        ...
        queue.enqueue(2);
        queue.enqueue(3);
        queue.print(); // Circular Queue: 1 2 3

        // Remove and peek
        System.out.println("Dequeued: " + queue.dequeue()); // Dequeued: 1
        queue.print(); // Circular Queue: 2 3
        ...
        queue.enqueue(5);
        queue.enqueue(6);
        queue.print(); // Circular Queue: 2 3 4 5 6

        // Size and empty check
        System.out.println("Size: " + queue.size()); // Size: 5
        System.out.println("Is empty? " + queue.isEmpty()); // Is empty? false
        System.out.println("Is full? " + queue.isFull()); // Is full? true

        // Dequeue and add to demonstrate circular nature
        System.out.println("Dequeued: " + queue.dequeue()); // Dequeued: 2
        queue.enqueue(7);
        queue.print(); // Circular Queue: 3 4 5 6 7
    }
}
